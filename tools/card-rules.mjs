...
// Anál má v této hře jediný směr: dělá ho muž ženě. Karta pro ženskou roli,
// která ji posílá do jeho zadku nebo na jeho prostatu, je chyba.
// „Nabídni mu anál“ je v pořádku – tam anál přijímá ona.
export const ANAL_NA_MUZI = new RegExp([
  'prostat',
